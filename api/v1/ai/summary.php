...
// generate() keys its cache read + write on the viewer's money tier
// (SummaryEngine::moneyTierFor($userId) → can_view_financials()), so a summary
// generated by a financial role is never served to a dispatcher.
// S-AI-SUMMARY-MONEY-KEY.
