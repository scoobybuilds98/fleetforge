...
| E01 | medium | app/admin/equipment/show.php | 2465 (loadStatusLog); rendered 1477-1530 | correctness | Status Log tab calls a non-existent API endpoint (status-log.php 404s) — tab always shows 'No status changes recorded' — ✅ **RESOLVED S-EQUIPMENT-AUDIT-FIX-2 (2026-06-22):** created `api/v1/equipment/units/status-log.php` (GET, `equipment:view`, parameterized read of `equipment_status_log` + users join, `{items:[…]}` envelope); live-verified 46 rows on T5301 |
