...
| Credit notes | FleetForge | QuickBooks credit memo | Overpayment and rounding credits stay in FleetForge only |
...
| Invoice write-offs | FleetForge | QuickBooks credit memo applied to the invoice | Recovering a write-off is done by hand in QuickBooks |
