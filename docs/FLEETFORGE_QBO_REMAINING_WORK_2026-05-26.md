...
- Phase QBO numbered total: 11/30 → 14/30 → 15/30 → 16/30 → **17/30** (S-QBO-12 + S-QBO-18 + S-QBO-13 + S-QBO-14 + S-QBO-15 + **S-QBO-19** advance the counter; SYNC-UI + GOTCHAS-PAYDOWN + PAYMENT-SYNC-UI are debt-paydowns)
- Debt-paydown/infra total: 27 → 30 → **31** (S-VENDOR-CURRENCY-COLUMN + S-QBO-BILL-SYNC-UI + S-QBO-BILL-GOTCHAS-PAYDOWN + **S-QBO-PAYMENT-SYNC-UI** registered as QBO paydowns; S-DOC-FRESHNESS-EXPAND/EXPAND-2 not counted — project infrastructure)
- D131 smoke count: 22 → 24 → 25 → 26 → **28** (S-QBO-19 added qbo_bill_payment_push + qbo_admin_retry_endpoints coverage-gap smoke per operator ask; S-QBO-15 added qbo_payments_embed (extended 28→31 same session); SYNC-UI + GOTCHAS-PAYDOWN + DOC-FRESHNESS-EXPAND-2 + PAYMENT-SYNC-UI extend existing smokes in-place)
- Migrate count: 65 → 71 → 72 → **73** (S-QBO-19 acc_qbo_bill_payment_map migration; S-QBO-15 acc_qbo_payment_initiations earlier; S-QBO-14 + PAYMENT-SYNC-UI ship NO migration)
