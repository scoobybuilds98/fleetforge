...
### F47 — Tell the manager INV-2026-01760 is fixed + apply/refund Mander's $91.19 account credit 🟡

**Surfaced by:** S-CAP-MULTILINE + S-ORPHAN-OVERFLOW-CN (2026-07-09) — manager reported INV-2026-01760 "all weird and won't let me edit" (stored subtotal -10.51, $0.00 mileage credit). Both bugs fixed, deployed, and the prod data remediated the same day (operator-authorized).
**State now:** INV-2026-01760 is a clean **$0.00 draft** (recon credit 2.00 capped from 12.51 · mileage credit 0.00 capped from 80.68 · GPS 2.00); the full net refund lives in **CN-CR-2026-00013 ($91.19, Mander Bros, active)**. CN-CR-2026-00011 ($40.01) and CN-CR-2026-00012 ($51.18) are **VOIDED** (orphan/over-route artifacts — superseded by CN-13; GL JEs reversed, 2060 ties to subledger).
**Operator action:**
1. Tell the manager: the invoice is correct at $0.00 — his mileage math (−2,017 km × $0.04 = −$80.68) was RIGHT and is inside the credit; his "+2 days × $18.33" base is NOT owed (the engine's cumulative reconciliation already credits −$12.51 because earlier drafts over-billed base rental — charging it would over-bill $49.17). Final invoices never go negative by design: the refund becomes an account credit.
2. When the lease-358 drafts are sent, **apply CN-CR-2026-00013 ($91.19)** against Mander's balance (or refund it).
3. Do NOT touch CN-11 / CN-12 — they are void and must stay void.
