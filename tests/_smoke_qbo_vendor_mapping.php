...
// ── C11: nav has 8 QuickBooks children incl. Vendors ───────
// Grew 7→8 in S-QBO-8 (Accounts between Vendors and Settings).
$c11Errors = [];
...
if (empty($c11Errors)) {
    echo "PASS C11 nav has 8 QuickBooks children with Vendors in expected position\n";
    $pass++;
} else {
