...
if ($qbo === null) {
    ...
    if (count($children) !== 15) {
        $c17Errors[] = 'expected 15 QuickBooks children, got ' . count($children) . ' (' . implode(', ', $labels) . ')';
    }
...
if (empty($c17Errors)) {
    echo "PASS C17 nav has 15 QuickBooks children with Accounts in expected position\n";
    $pass++;
} else {
