...
if ($qbo === null) {
    ...
    if (count($children) !== 11) {
        $c17Errors[] = 'expected 11 QuickBooks children, got ' . count($children) . ' (' . implode(', ', $labels) . ')';
    }
...
if (empty($c17Errors)) {
    echo "PASS C17 nav has 11 QuickBooks children with Accounts in expected position\n";
    $pass++;
} else {
