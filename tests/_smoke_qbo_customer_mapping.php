...
if ($qbo === null) {
    ...
    if (count($children) !== 14) {
        $c11Errors[] = 'expected 14 QuickBooks children, got ' . count($children) . ' (' . implode(', ', $labels) . ')';
    }
...
if (empty($c11Errors)) {
    echo "PASS C11 nav has 14 QuickBooks children with Customers in expected position\n";
    $pass++;
} else {
