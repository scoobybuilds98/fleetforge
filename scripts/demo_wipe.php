...
// scripts/stage_demo_to_production.php), only ff_demo_wipe_execute() is defined;
// dev-only guards + top-level execution are skipped. Direct invocation is
// unchanged — all three guard layers still fire in standalone mode.
// (D-STAGE-PROD-TOOL, S-STAGE-DEMO-TO-PRODUCTION)
if (!defined('FF_DEMO_WIPE_INCLUDE')) {
    ...
    define('DEMO_WIPE_TOKEN', '--i-understand-this-wipes-dev');
...
/**
 * Execute the full demo-wipe: truncate all data tables, reset equipment
 * counters + status, and resync invoice/JE number counters.
 *
 ...
 */
function ff_demo_wipe_execute(): void
{
