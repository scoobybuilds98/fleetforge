...
```
Session S020 — Compliance Module (Phase 11)

S019 — Rates Module — fully complete and tested (19/19 stop conditions pass).
  Built: api/v1/rate_cards/ (5 endpoints), api/v1/customer_equipment_rates/ (3 endpoints),
         api/v1/leases/lookup_rates.php, app/admin/rates/index.php (fixes 404),
         app/admin/rates/create.php, app/admin/rates/show.php.
  Patched: app/admin/leases/create.php — rate pre-fill with source banner.
  Bug fixed: variable-variable naming in rate create + upsert (camelCase declared,
             snake_case loop assigned → rates stored as NULL). Fixed: field→varName map.
...
READ IN THIS ORDER:
  ...
  3. FLEETFORGE_SPEC_FINAL.md             ← grep "compliance\|expiry\|cvi\|mvi\|registration\|insurance"
  4. FLEETFORGE_DATABASE_MASTER.sql       ← grep "cvi_expiry\|registration_expiry\|mvi_expiry\|insurance_expiry"
