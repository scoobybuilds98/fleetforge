...
S021 — Reports Module — complete.
  6 files built: lib/Reports/ReportBuilder.php,
  api/v1/reports/{revenue,fleet,customer,compliance}.php,
  app/admin/reports/index.php.
  4 tabs / 20 views / 15 charts / CSV export / 15-min cache. 8/8 SC passed.
