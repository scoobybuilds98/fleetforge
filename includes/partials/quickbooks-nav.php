 ...
 *
 *   [Dashboard] [Sync Queue] [Sync Log] [Drift] [Customers]      [Settings]
 *
...
// Sync Log / Drift / Customers / Settings) so operators have a single
// mental model across both navigation surfaces.
$_qboNavGroups = [
    [
        'label' => 'Dashboard',
