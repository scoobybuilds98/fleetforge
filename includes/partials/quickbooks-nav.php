 ...
 *
 *   [Dashboard] [Sync Queue] [Sync Log] [Drift] [Customers] [Vendors]      [Settings]
 *
...
// Sync Log / Drift / Customers / Vendors / Settings) so operators have
// a single mental model across both navigation surfaces.
$_qboNavGroups = [
    [
        'label' => 'Dashboard',
